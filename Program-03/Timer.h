/*
 * Filename:  Timer.h
 * Author:  Dr. Brown, modified by April Crockett, modified by Rus Hoffman
 * Date:  3/14/2018
 * Purpose:  provides function to get the current time and get the total time given an end and start time.
 */
#if !defined(TIMER_H)
#define TIMER_H
#include <ctime>
